  ...
  return (
    <div className="flex items-center gap-2 px-4 py-3 border-t border-white/[0.06] bg-white/[0.01]">
      <input
        ...
        disabled={disabled}
        className="flex-1 bg-white/5 border border-white/[0.06] rounded-full px-4 py-2 text-sm text-white/90 placeholder-white/50 outline-none focus:border-accent/50 focus:bg-white/[0.08] transition-all duration-300 disabled:opacity-50"
      />
      <button
