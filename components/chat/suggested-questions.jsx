      ...
      <div className="flex flex-wrap gap-2 justify-center">
        {questions.map((q, i) => (
          <motion.button
            ...
            onClick={() => onSelect(q)}
            className="text-xs bg-white/5 hover:bg-white/10 hover:text-accent border border-white/[0.06] hover:border-accent/40 text-white/60 px-3 py-1.5 rounded-full transition-all duration-300"
          >
            {q}
          </motion.button>
        ))}
